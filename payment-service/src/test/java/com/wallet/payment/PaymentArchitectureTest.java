...
class PaymentArchitectureTest {
    ...
    private static final JavaClasses CLASSES = new ClassFileImporter()
        ...
        .importPackages("com.wallet.payment");
    ...
    @Test
    @DisplayName("Sin inyección por campo (@Autowired en fields)")
    ...
    @Test
    @DisplayName("Excepciones de negocio viven en domain o en infrastructure.web.exception")
