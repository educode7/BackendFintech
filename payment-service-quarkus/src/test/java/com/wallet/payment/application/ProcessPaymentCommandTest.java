...
class ProcessPaymentCommandTest {
    ...
    void nullUserId() {
        assertThrows(IllegalArgumentException.class,
                () -> new ProcessPaymentCommand(null, new Money(BigDecimal.TEN, "USD"), "key"));
    }
    ...
    void nullAmount() {
        assertThrows(IllegalArgumentException.class,
                () -> new ProcessPaymentCommand("user-001", null, "key"));
    }
    ...
    void nullKey() {
        assertThrows(IllegalArgumentException.class,
                () -> new ProcessPaymentCommand("user-001", new Money(BigDecimal.TEN, "USD"), null));
    }
}
