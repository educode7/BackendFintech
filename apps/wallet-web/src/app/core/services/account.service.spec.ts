...
describe('AccountService', () => {
  ...
  describe('getById', () => {
    it('should GET /api/v1/accounts/:accountId', () => {
      ...
      service.getById('acc-1').subscribe((account) => {
        expect(account.accountId).toBe('acc-1');
      });
  ...
  describe('deposit', () => {
    it('should POST to /api/v1/accounts/:accountId/deposits', () => {
      ...
      service.deposit('acc-1', { amount: '50.00', currency: 'USD' }).subscribe((account) => {
  ...
  describe('withdraw', () => {
    it('should POST to /api/v1/accounts/:accountId/withdrawals', () => {
      ...
      service.withdraw('acc-1', { amount: '50.00', currency: 'USD' }).subscribe((account) => {
